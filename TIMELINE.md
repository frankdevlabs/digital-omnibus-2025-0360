...
| 2026-06-09 | **Formal Telecom Council (Telecomraad) — Digital Omnibus on the agenda**; Presidency progress report to ministers (no general approach — working-party stage ongoing; Cyprus Presidency concedes the file passes unclosed to the Irish Presidency). Tweede Kamer pre-Council tweeminutendebat ongecorrigeerd report and motion voting results (1206 Van den Berg — withdrawn; 1205 Kathmann — ICT supplier preference, outcome TBC) confirmed published. Council-level outcome to verify from Consilium press release | [Tweede Kamer](https://www.tweedekamer.nl/zoeken?qry=omnibus+digitaal&srt=date%3Adesc%3Adate&cfg=tksearch&sta=1) · [triage #38](docs/triage/2026-06-09-issue-38.md) |
