...
The **lead committees' joint draft report** — the **joint ITRE/LIBE draft report** (Rule 59,
co-rapporteurs **Aura Salla**, ITRE/EPP, and **Marina Kaljurand**, LIBE/S&D, PE786.818v01-00, 22 Jun
2026; [register](../sources/README.md#european-parliament)) — is Parliament's first **cross-strand**
position and is now transcribed ([extract, 78 amendments](../extracts/parliament/CJ72-PR-786818_joint-itre-libe-draft-report.md)).
Like the two opinions it runs **counter-current to the omnibus's deregulation**, but across the whole
file: it **restores the P2B Regulation** (Am 77–78 delete its repeal), **restores the GDPR Art 22**
right not to be subject to solely automated decisions and **defines meaningful human intervention**
(Am 51, 53), **reverses the subject-access "abuse" reframing** (Am 5, 48–49), keeps scientific-research
/ further-processing but **re-anchors it to Art 89 safeguards** (Am 2, 3, 45), tightens **biometric
verification** (Am 4, 46, 70), shifts the **breach-notification template and the DPIA lists/templates
back to the EDPB** (Am 7–8, 56–67), **keeps the breach deadline at 96 hours** (Am 54, not back to 72h),
adds **NIS2 'report-once' / harmonised-application** guidance (Am 11, 75–76), and strengthens **Data Act**
intermediation, B2G-emergency, third-country-access transparency and open-data safeguards (Am 13–42).
This **partly refutes** the earlier *unconfirmed* report (J. Tar, 12 Jun) that LIBE amendments would
*strip* the AI-training, pseudonymisation and research provisions — the joint report **conditions and
...
| **Biometric verification (Art 9(2)(l))** | New derogation under sole control | **Retained with safeguards** (one-to-one, possession, MS/Union legal basis) | **Joint report tightens** — "one-to-one" verification + Union-law safeguards ([Am 46](../extracts/parliament/CJ72-PR-786818_joint-itre-libe-draft-report.md#amendment-46), recital 34 [Am 4](../extracts/parliament/CJ72-PR-786818_joint-itre-libe-draft-report.md#amendment-4)) | Welcomed |
| **Abuse-of-rights / DSAR (Art 12(5), 57)** | Refuse where reasonable grounds of other purpose | **Retained but reformulated** — "abusive intention" must be demonstrated | **Joint report reverses the "abuse" reframe** — "choice between" fee or refusal, controller bears the burden ([Am 48–49](../extracts/parliament/CJ72-PR-786818_joint-itre-libe-draft-report.md#amendment-48), recital 35 [Am 5](../extracts/parliament/CJ72-PR-786818_joint-itre-libe-draft-report.md#amendment-5)); **IMCO removes** the restriction + adds an anti-circumvention duty ([Am 103–107](../extracts/parliament/IMCO-PA-789877_draft-opinion.md#amendment-103)) | Criticises link to *purpose* of request |
...
| **Automated decisions (Art 22)** | Rewrite weakening contractual-necessity test | **Largely restored to current GDPR**; "regardless of whether…" clause in (a) deleted | **Joint report restores** the *right not to be subject* to solely automated decisions ([Am 51](../extracts/parliament/CJ72-PR-786818_joint-itre-libe-draft-report.md#amendment-51)) and **defines meaningful human intervention** (Art 22(3), [Am 53](../extracts/parliament/CJ72-PR-786818_joint-itre-libe-draft-report.md#amendment-53); recital 38 [Am 6](../extracts/parliament/CJ72-PR-786818_joint-itre-libe-draft-report.md#amendment-6)) — goes beyond Council | Welcomed |
| **Breach notification (Art 33)** | High-risk threshold; **72h**; EDPB template | High-risk threshold; **96h**; via national entry point; EDPB lists/template | **Joint report keeps 96h** ([Am 54](../extracts/parliament/CJ72-PR-786818_joint-itre-libe-draft-report.md#amendment-54)) and has the **EDPB establish/publish** the template + high-risk list ([Am 56–57](../extracts/parliament/CJ72-PR-786818_joint-itre-libe-draft-report.md#amendment-56), recital 39 [Am 7](../extracts/parliament/CJ72-PR-786818_joint-itre-libe-draft-report.md#amendment-7)); **IMCO**: EDPB publishes the template + non-regression safeguard on the SEP ([Am 108–110](../extracts/parliament/IMCO-PA-789877_draft-opinion.md#amendment-108)) | **Welcomed** threshold + 96h |
| **DPIA EU-list (Art 35)** | Commission implementing acts | **Retained, power moved to EDPB** | **Joint report**: **EDPB establishes and makes public** the lists, template and methodology; Commission only "may" adopt the template ([Am 58–63](../extracts/parliament/CJ72-PR-786818_joint-itre-libe-draft-report.md#amendment-58), recital 40 [Am 8](../extracts/parliament/CJ72-PR-786818_joint-itre-libe-draft-report.md#amendment-8)) | Supports EDPB role |
| **EDPB tasks/consistency & DPO contact (Art 64, 70, 37(7))** | EDPB prepares proposals; Art 64(1)(a)/70(1)(h) deleted | **EDPB establishes** lists/templates + Art 32 guidance + Art 29a opinion ([extract](../extracts/council/ST-9547-2026_gdpr-art3-amendments.md#points-1214--articles-64--70-edpb-tasks-and-consistency)) | **Joint report**: Art 70 tasks have the **EDPB *establish*** (not merely propose) the DPIA lists, DPIA template and breach template ([Am 64–67](../extracts/parliament/CJ72-PR-786818_joint-itre-libe-draft-report.md#amendment-64)); **IMCO**: EDPB publishes lists/templates; DPA powers + fines extended to software providers ([Am 112–114](../extracts/parliament/IMCO-PA-789877_draft-opinion.md#amendment-112)) | Wants EDPB to prepare *and approve* |
...
| **Single-entry point (NIS2 Art 23a-d; DORA/CER/eIDAS)** | ENISA SEP; report once, share many; 18–24 months | **Retained** — ENISA info point + Member State national entry points; 30-month reporting switch-over | Broadly supported; **joint report** adds **'report-once' harmonised-application guidance** (new NIS2 Art 14a [Am 75](../extracts/parliament/CJ72-PR-786818_joint-itre-libe-draft-report.md#amendment-75)) + a **common SEP notification template** (Art 23a(3a) [Am 76](../extracts/parliament/CJ72-PR-786818_joint-itre-libe-draft-report.md#amendment-76), recital 49a [Am 11](../extracts/parliament/CJ72-PR-786818_joint-itre-libe-draft-report.md#amendment-11)); **IMCO** adds a non-regression safeguard ([Am 110](../extracts/parliament/IMCO-PA-789877_draft-opinion.md#amendment-110)) | Supports with safeguards |
| **Repeals (DGA / P2B / FFNPD / Open Data)** | Repeal + consolidate into Data Act | **DGA, FFNPD, Open Data repealed; P2B partially amended** (key articles deleted, not wholly repealed) | **Joint report restores P2B in full** — deletes the repeal of Reg (EU) 2019/1150 and its derogation ([Am 77–78](../extracts/parliament/CJ72-PR-786818_joint-itre-libe-draft-report.md#amendment-77), repeal recital 59 [Am 12](../extracts/parliament/CJ72-PR-786818_joint-itre-libe-draft-report.md#amendment-12)); **JURI + IMCO** likewise oppose the P2B repeal ([IMCO Am 123–124](../extracts/parliament/IMCO-PA-789877_draft-opinion.md#amendment-123)) | Out of remit |
| **EUDPR mirror (Omnibus Art 4)** | Point-for-point mirror of the GDPR changes ([extract](../extracts/commission/COM-2025-837_eudpr-art4.md)) | **Not operatively amended**; alignment deferred (rec 43) | **Joint report mirrors** its GDPR changes into the EUDPR — biometric verification, Art 24 automated decisions, EDPB-led DPIA template ([Am 68–74](../extracts/parliament/CJ72-PR-786818_joint-itre-libe-draft-report.md#amendment-68)) | GDPR comments apply equally; reject EUDPR Art 39 amendment |
...
and *strengthening* (not deleting) the Art 88b consent-signal regime. The **lead committees' joint
draft report now confirms this direction cross-strand** — restoring P2B and GDPR Art 22, reversing the
