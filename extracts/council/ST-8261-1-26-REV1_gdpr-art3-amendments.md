...
> compromise **ST 6406/26** (Feb) and the later **ST 9547/26** (May). Where the Presidency struck a whole
> provision it is marked **[DELETED in ST 8261/1/26 REV 1]**. Where a passage is illegible/uncertain it is
> marked `[illegible in source]`. Numbering follows **this document's own** point/article numbering. Always
> verify against the authoritative document before relying on it. See [`../../NOTICE`](../../NOTICE).
...
**(a) Addition to Art 4(1) on the concept of personal data — [DELETED in ST 8261/1/26 REV 1].**
...
▸ Same deletion as in ST 6406/26 (Feb) and carried into May (ST 9547/26). See
...
- ~~(33) 'electronic communications networks' — **[DELETED in ST 8261/1/26 REV 1]**~~;
...
- **(36) 'media service provider'** = a media service provider as defined in Article 2(2) of Regulation (EU) 2024/1083;
...
conditions of Article 6(4) of this Regulation" and **adds "subject to the application of appropriate
safeguards"**. (Only the comma after "Regulation" is struck in the source.) Carried into May.
...
possession" and adds the Union/Member-State-law safeguards limb; and **9(5)** adds the **regular-verification
+ documentation** duty over the AI life cycle. This version uses **"delete"** (February used "remove"; May
changes it to **"erase"**). See [provision page](../../docs/provisions/gdpr-art9-special-categories-ai.md).
...
The chapeau in the source reads, consolidated, *"In Article 13, the following paragraph is added:"* (the
February "paragraph 4 is replaced by the following" is struck). The added paragraph:

*"4. Paragraphs 1, 2 and 3 shall not apply where there are reasonable grounds to assume that the data
...
Added: *"5. When the further processing takes place for scientific research purposes **by the same
controller and where and insofar as** the provision of information referred to under paragraphs 1, 2 and 3
proves impossible or would involve a disproportionate effort or in so far as the obligation referred to in
paragraph 1 of this Article is likely to render impossible or seriously impair the achievement of the
objectives of that further processing, subject to the conditions and safeguards referred to in Article
89(1), the controller does not need to provide the information referred to under paragraphs 1, 2 and 3. In
such cases the controller shall take appropriate measures to protect the data subject's rights and freedoms
and legitimate interests, including making the information publicly available."*
▸ vs ST 6406/26: adds "**by the same controller and where and insofar as**" and relocates "subject to the
conditions and safeguards referred to in Article 89(1)" to the end.
...
Paragraphs 1 and 2 replaced (merged into a single new paragraph 1). Consolidated:
...
**struck out** — the May approach. (Note: April **keeps** the supporting recital 38, which May deletes —
see [recitals](ST-8261-1-26-REV1_recitals.md#recital-38-article-22).) See
...
controller alone), with explicit reference to the lists under Article 35(4) and (5). Substance otherwise as
in the current Article 25 (state of the art / cost / nature, scope, context and purposes; pseudonymisation
and data minimisation by design; data-minimisation by default; personal data not made accessible to an
indefinite number of natural persons without the individual's intervention).
...
▸ **Deadline reverts to 72 hours** in this version. The source shows "~~96~~ **72** hours" in both places
(96 struck through, 72 the bold addition — confirmed against the page image). The arc is therefore:
current GDPR **72h** → ST 6406/26 (Feb) **96h** → **ST 8261/1/26 REV 1 (Apr) 72h** → ST 9547/26 (May) **96h**.
Routing also changes vs February: the **single-entry point / Article 23a** is replaced by the **national
entry point / Article 23b** (as in May); threshold remains high-risk only. See
...
*"29a — Pseudonymisation and identification of a natural person
...
▸ The Commission's implementing-act paragraphs (the old chapeau, (2)(a)–(b) and (4)–(5)) are **struck out**.
...
- **14.** New points inserted in Article 70(1):
  ...
  - **(hca)** issue guidelines, recommendations and best practices for further specifying the appropriate
...
▸ vs ST 6406/26: each "prepare and transmit to the Commission a proposal for" becomes "**establish**"; point
**(hca)** is repurposed (February's (hca) covered pseudonymisation; here it covers Article 32 security), and
a new **(hcb)** carries the Article 29a opinion. Matches May.
...
88c AI legitimate interest). The chapeau is amended, consolidated, to *"After Article 88, the following
article is added:"* (singular). In ST 8261/1/26 REV 1 — already as in May:

- **Article 88a (terminal-equipment consent) — [DELETED in ST 8261/1/26 REV 1].** The whole article (consent
  to store/access terminal equipment; consent-exempt purposes; single-click refusal / 6-month no-repeat;
  staged application) is **struck out**. The cookie-consent regime is **kept in the ePrivacy Directive**
  instead (amended Art 5(3)). See [`ST-8261-1-26-REV1_eprivacy-art5.md`](ST-8261-1-26-REV1_eprivacy-art5.md)
...
- **Machine-readable consent article — RETAINED** (the source renumbers the Commission's Article 88b; the
  number is in flux, shown as "**8b**"). Title: *"Consent through automated and machine-readable indications
  of data subject's choices with respect to processing of personal data in the terminal equipment of natural
  persons"*. Consolidated substance:
  - **(1)** *"For the purpose of data subject consent to the storing of personal data, or gaining of access
    to personal data already stored in the terminal equipment of a natural person in accordance with
    Directive 2002/58/EC,"* controllers shall ensure that their online interfaces allow data subjects to:
    (a) **give consent for specific categories of purposes** through automated and machine-readable means…;
    (b) **refuse** a request for consent **or** exercise the right to object pursuant to Article 21(2)
    through automated and machine-readable means.
  - **(2)** controllers shall **ensure that their online interfaces respect signals expressing** the choices
    made by data subjects in accordance with paragraph 1.
  - **(3)** media-service-provider exemption (when providing a media service).
  - **(4)** the Commission requests standardisation (Reg (EU) 1025/2012); conformity presumption for
    interfaces meeting harmonised standards.
  - **(5)** paragraphs 1 and 2 apply from [OP date = 24 months].
  - **(6)** *"Providers of web browsers **and providers of operating systems of terminal equipment in
    relation to software applications operating on that terminal equipment**"* shall provide the technical
    means to give/refuse consent and exercise the Art 21(2) objection (the February "which are not SMEs"
    qualifier is struck).
  - **(7)** paragraph 6 applies from [OP date = 48 months].
  - **(7a)** *(new)* providers of web browsers and of operating systems **shall not process** the data
    subject's choices referred to in paragraph 1 for any purpose other than transmitting the signal to
    providers of online interfaces.
...
- **Article 88c (AI legitimate interest) — [DELETED in ST 8261/1/26 REV 1].** The whole article making AI
  development/operation a legitimate interest under Art 6(1)(f) is **struck out**.
  ▸ Major change vs ST 6406/26, where Articles 88a, 88b and 88c were **all present**. In this version the
  AI legitimate-interest statement is removed **entirely**: the operative Article 88c is deleted **and** its
  supporting recitals 30 and 31 are deleted, with **no replacement recital** (the interpretive recital 33a
  that carries the statement is a **May** addition — it does **not** exist here). See
  [recitals](ST-8261-1-26-REV1_recitals.md#recitals-30-31-ai-legitimate-interest) and
...
**See also (for diffing):** [Feb GDPR Art 3](ST-6406-2026_gdpr-art3-amendments.md) ·
[May GDPR Art 3](ST-9547-2026_gdpr-art3-amendments.md)
