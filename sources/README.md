...
| PE 790.968 | **Tabled amendments to the joint ITRE/LIBE draft report** (PE786.818) — a **second confirmed part** of the >1,762-amendment set, **amendments 401–526** (128 pp; broad cross-party tablers); not the rapporteurs' text and not an adopted position (joint committee vote ~Q4 2026). **Only the German language version is published** — the **English** (`CJ72-AM-790968_EN.pdf`) 404s at doceo as of 19 Aug 2026, so this is registered **metadata-only** (no per-provision claims; `pending_operative_text` for the EN transcription); lead: [@montezumachavez](https://bsky.app/profile/montezumachavez.bsky.social/post/3mteawpspbs2l) (`T3-01`) relaying L. Montezuma (image = the doc cover) | 2026-07-27 | [PDF (DE)](parliament/CJ72-AM-790968_amendments-401-526_DE_2026-07-27.pdf) · [doceo (EN, pending)](https://www.europarl.europa.eu/doceo/document/CJ72-AM-790968_EN.pdf) |
