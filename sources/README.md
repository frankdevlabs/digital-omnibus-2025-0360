...
| PE 791.883 | **Tabled amendments to the joint ITRE/LIBE draft report** (PE786.818) — after the 15 Jul deadline, **more than 1,762 MEP amendments** across a multi-part set; not the rapporteurs' text and not an adopted position (joint committee vote ~Q4 2026). **Metadata only** — one part confirmed (PE791.883 = **amendments 1741–1840**), full set not yet transcribed (other PE parts pending; ITRE/LIBE listing feeds WAF-gated, health #118); lead: [@montezumachavez](https://bsky.app/profile/montezumachavez.bsky.social/post/3mrpq7le4zs25) (`T3-01`) relaying L. Montezuma; OEIL-corroborated | 2026-07-27 | [doceo](https://www.europarl.europa.eu/doceo/document/CJ72-AM-791883_EN.pdf) |
