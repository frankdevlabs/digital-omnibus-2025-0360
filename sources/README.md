...
| BfDI (DE) | **Datenbarometer report** — *"Weg mit den Cookie-Bannern! Cookie-Manager … im EU Digital Omnibus verankern"* (German federal DPA): urges anchoring binding, once-set, cross-site consent signals / recognised consent-managers via the Digital Omnibus (substance of Art 88b) | 2026-08-12 | [`advisory/BfDI-DATENBAROMETER-2026_cookie-manager-empfehlungen_2026-08-12.pdf`](advisory/BfDI-DATENBAROMETER-2026_cookie-manager-empfehlungen_2026-08-12.pdf) | [PM 12/2026](https://www.bfdi.bund.de/SharedDocs/Pressemitteilungen/DE/2026/12_Cookie-Banner.html) · positions in [`../docs/stakeholders.md`](../docs/stakeholders.md#regulators) |
